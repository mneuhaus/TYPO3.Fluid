<?php
namespace TYPO3\Fluid\Tests\Unit\ViewHelpers\Widget\Controller;
 ...
 */
class PaginateControllerTest extends \TYPO3\Fluid\ViewHelpers\ViewHelperBaseTestcase {
	...
	public function setUp() {
		$this->controller = $this->getAccessibleMock('TYPO3\Fluid\ViewHelpers\Widget\Controller\PaginateController', array('dummy'), array(), '', FALSE);
	}
